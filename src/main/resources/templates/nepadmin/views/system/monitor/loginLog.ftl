<div class="layui-fluid" id="familyList" lay-title="登录日志">
    <div class="layui-row layui-col-space12">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body nepadmin-table-full">
                    <div class="layui-card-header"><b>登录日志</b></div>
...
<script>
    layui.use(['admin', 'table', 'form', 'dropdown', 'jquery'], function (admin, table, form, dropdown, $) {
        ...
        var tableIns = table.render({
            ...
            url: '${basePath}/system/monitor/loginLogListData',
            height: 'full-165',
            cols: [[
        ...
        table.on('tool(list-table)', function (obj) {
            ...
            if (layEvent === 'del') {
                admin.modal.confirm('删除日志', '确定删除该条登录日志？', function () {
                    admin.get('${basePath}system/monitor/deleteLoginId?id='+data.id, null, function () {
